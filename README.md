...
**14 suites - 137 vectors** across 5 issuers and 6 consumer semantics.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `github` | 12 | 15 | 5 | 10 | 12 | 12 | **66** |
| `gitlab` | 5 | 5 | 6 | 6 | 5 | 6 | **33** |
| `bitbucket` | 1 | 2 | 3 | - | - | - | **6** |
| `circleci` | 4 | - | 3 | - | - | 6 | **13** |
| `terraform-cloud` | 3 | 3 | 1 | - | 6 | 6 | **19** |
| **Total** | **25** | **25** | **18** | **16** | **23** | **30** | **137** |
...
Judgments: 32 safe - 45 caution - 38 dangerous - 22 ungraded (mechanical no-match / contrast vectors carry no safety grade).

Provenance: 126 `documented` - 11 `observed`.
