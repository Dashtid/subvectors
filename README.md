...
**10 suites - 107 vectors** across 3 issuers and 6 consumer semantics.
...
| `terraform-cloud` | - | - | - | - | 6 | 6 | **12** |
| **Total** | **17** | **20** | **11** | **16** | **19** | **24** | **107** |

Suites:

- `github-aws` 0.3.0 - 32 vectors
...
Judgments: 27 safe - 34 caution - 29 dangerous - 17 ungraded (mechanical no-match / contrast vectors carry no safety grade).
