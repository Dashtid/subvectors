...
**14 suites - 146 vectors** across 5 issuers and 6 consumer semantics.
...
Judgments: 32 safe - 48 caution - 42 dangerous - 24 ungraded (mechanical no-match / contrast vectors carry no safety grade).

Provenance: 135 `documented` - 11 `observed`.
