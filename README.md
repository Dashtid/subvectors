...
> Status: v0.5.1 on PyPI - the corpus ships inside the wheel. An independent personal
...
**14 suites - 145 vectors** across 5 issuers and 6 consumer semantics.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `github` | 15 | 19 | 6 | 10 | 12 | 12 | **74** |
| `gitlab` | 5 | 5 | 6 | 6 | 5 | 6 | **33** |
| `bitbucket` | 1 | 2 | 3 | - | - | - | **6** |
| `circleci` | 4 | - | 3 | - | - | 6 | **13** |
| `terraform-cloud` | 3 | 3 | 1 | - | 6 | 6 | **19** |
| **Total** | **28** | **29** | **19** | **16** | **23** | **30** | **145** |
...
Judgments: 32 safe - 47 caution - 42 dangerous - 24 ungraded (mechanical no-match / contrast vectors carry no safety grade).

Provenance: 134 `documented` - 11 `observed`.
