...
**14 suites - 151 vectors** across 5 issuers and 6 consumer semantics.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `github` | 16 | 23 | 6 | 10 | 12 | 12 | **79** |
| `gitlab` | 5 | 5 | 6 | 6 | 5 | 6 | **33** |
| `bitbucket` | 1 | 2 | 3 | - | - | - | **6** |
| `circleci` | 4 | - | 4 | - | - | 6 | **14** |
| `terraform-cloud` | 3 | 3 | 1 | - | 6 | 6 | **19** |
| **Total** | **29** | **33** | **20** | **16** | **23** | **30** | **151** |
...
Judgments: 33 safe - 49 caution - 45 dangerous - 24 ungraded (mechanical no-match / contrast vectors carry no safety grade).

Provenance: 140 `documented` - 11 `observed`.
