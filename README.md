...
**14 suites - 157 vectors** across 5 issuers and 6 consumer semantics.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `github` | 16 | 28 | 7 | 10 | 12 | 12 | **85** |
| `gitlab` | 5 | 5 | 6 | 6 | 5 | 6 | **33** |
| `bitbucket` | 1 | 2 | 3 | - | - | - | **6** |
| `circleci` | 4 | - | 4 | - | - | 6 | **14** |
| `terraform-cloud` | 3 | 3 | 1 | - | 6 | 6 | **19** |
| **Total** | **29** | **38** | **21** | **16** | **23** | **30** | **157** |
...
Judgments: 33 safe - 51 caution - 49 dangerous - 24 ungraded (mechanical no-match / contrast vectors carry no safety grade).

Provenance: 146 `documented` - 11 `observed`.
