...
> Status: v0.5.2 on PyPI - the corpus ships inside the wheel. An independent personal
...
**14 suites - 147 vectors** across 5 issuers and 6 consumer semantics.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `github` | 15 | 20 | 6 | 10 | 12 | 12 | **75** |
| `gitlab` | 5 | 5 | 6 | 6 | 5 | 6 | **33** |
| `bitbucket` | 1 | 2 | 3 | - | - | - | **6** |
| `circleci` | 4 | - | 4 | - | - | 6 | **14** |
| `terraform-cloud` | 3 | 3 | 1 | - | 6 | 6 | **19** |
| **Total** | **28** | **30** | **20** | **16** | **23** | **30** | **147** |
...
Judgments: 32 safe - 48 caution - 43 dangerous - 24 ungraded (mechanical no-match / contrast vectors carry no safety grade).

Provenance: 136 `documented` - 11 `observed`.
